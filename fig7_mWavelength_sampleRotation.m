...
hold on
text(-8, k_max, '$k_{max}$', 'interpreter', 'latex', 'horizontalalignment', 'left','FontSize',9)
...
set(gcf,'color','w')
exportgraphics(fig,'mWavelength_SR.png','Resolution',300)
exportgraphics(fig,'mWavelength_SR.eps')